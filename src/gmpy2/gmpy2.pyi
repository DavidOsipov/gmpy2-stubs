...
class mpz:
    ...
    # __pow__
    @overload
    def __pow__(self, other: Union["mpc", complex]) -> "mpc": ...
    @overload
    def __pow__(self, other: Union["mpfr", float, "mpq"]) -> "mpfr": ...
    @overload
...
class mpq:
    ...
    def __pow__(self, other: Union["mpfr", float, "mpq"]) -> "mpfr": ...
    @overload
    def __pow__(self, other: _IntLike) -> "mpq": ...
    # No implementation signature in stubs
    # __rpow__ (NO MOD)
    @overload
    def __rpow__(self, other: Union["mpc", complex]) -> "mpc": ...
...
class mpfr:
    ...
    def __pow__(self, other: Union["mpc", complex], /) -> "mpc": ...
    @overload
    def __pow__(self, other: _RealLike, /) -> "mpfr": ...
    # No implementation signature in stubs
    # __rpow__ (NO MOD)
    @overload
    def __rpow__(self, other: Union["mpc", complex], /) -> "mpc": ...
...
class mpc:
    ...
    # Removed implementation signature
    def __str__(self) -> str: ...
    def __repr__(self) -> str: ...
    def __bool__(self) -> bool: ...
    def __hash__(self) -> int: ...
    ...
    def __pow__(self, other: _ComplexLike, /) -> "mpc": ...
    def __rpow__(self, other: _ComplexLike, /) -> "mpc": ...  # No mod
